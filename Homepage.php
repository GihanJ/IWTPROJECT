    ...
    <div id="mainbody">
        ...
        <div class="n-bordered td">
            <table width="90%"align="center"  border="1px"  cellspacing="10px"  cellpadding="10%" >
                ...
                <tr>
                    <td><img src="Images/hiking.jpg"width="100%" height="70%"  >
                        <p><hr>Hiking</p></td>

                    <td><img src="Images/cycling.jpg"width="100%" height="70%">
                        <p><hr>Cycling </p></td>

                    <td><img src="Images/caving.jpg"width="100%" height="70%" >
                        <p><hr>Caving</p></td></tr>

                <tr>
                    <td ><img src="Images/camping.jpg"width="100%" height="70%">
                        <p><hr>Camping </p></td>
                    <td><img src="Images/fishing.jpg"width="100%" height="70%">
                        <p><hr>Fishing</p></td>
                    <td><img src="Images/rafting.jpg"width="100%" height="70%">
                        <p><hr>Rafting</p></td>
